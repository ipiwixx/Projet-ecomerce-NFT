              ...
              <form action="<?= SERVER_URL ?>/boutique/" method="GET">
                <ul class="nav nav-tabs mb-3" id="myTab" role="tablist">
                  ...
                  <li class="nav-item" role="presentation">
                    <a href="<?= SERVER_URL ?>/boutique/<?= $categ->getRefInterne() ?>/" class="nav-link" id="<?= $categ->getLibelle() ?>-tab"
                       role="tab" aria-controls="<?= $categ->getLibelle() ?>"><?= $categ->getLibelle() ?></a>
                  </li>
                  <?php } ?>
                  <li class="nav-item" role="presentation">
