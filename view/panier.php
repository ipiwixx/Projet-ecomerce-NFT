                    ...
                    <div class="col-md-8">
                      <div class="card-body">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-2">
                            <input type="number" min="1" max="<?= $unNft->getQuantiteStock() ?>" data-qte="<?php if($unNft->getQuantiteStock() < $unNft->getQtePanier()) { echo $unNft->getQuantiteStock(); } else { echo $unNft->getQtePanier(); }?>" data-id="<?= $unNft->getId() ?>" name="panier[quantity][<?= $unNft->getId() ?>]" value="<?php if($unNft->getQuantiteStock() < $unNft->getQtePanier()) { echo $unNft->getQuantiteStock(); } else { echo $unNft->getQtePanier(); }?>" class="qtePanier" id="validationCustom01">
                          </div>
