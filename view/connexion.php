        ...
        <div class="row py-3">
          ...
          <div class="col-lg-2">
            ...
            <div class="mb-3">
              ...
              <input type="email" name="email" class="form-control" id="floatingInput1" placeholder="name@example.com" value="<?php if(isset($_COOKIE['comail'])) { $decrypted_chaine = openssl_decrypt($_COOKIE['comail'], 'AES-128-ECB', 'gK/9NcMJdNxJTtmp0SBa7w==xLCs.xunD9uNzief2gw9Qh.ZP7vuoCOCS3l'); echo $decrypted_chaine; }?>" required>
            </div>
          </div>
          <div class="col-lg-5"></div>
          <div class="col-lg-5"></div>
          <div class="col-lg-2">
            <div class="mb-3 lblCon">
              ...
              <input type="password" name="mdp" class="form-control" id="floatingInput2" placeholder="Mot de passe" value="<?php if(isset($_COOKIE['copassword'])) { $decrypted_chaine = openssl_decrypt($_COOKIE['copassword'], 'AES-128-ECB', 'gK/9NcMJdNxJTtmp0SBa7w==xLCs.xunD9uNzief2gw9Qh.ZP7vuoCOCS3l'); echo $decrypted_chaine; }?>" required> 
